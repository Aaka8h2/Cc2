...
admin_id = ''  # اي دي بتاعك هنا
bot = telebot.TeleBot("")# توكن بتاعك هنا
#AddUser
def load_users():
    try:
...
Free Telegram Bot Mutli Purpose Source Code
Developed By @RLSilence My Brother @O_An0 اجدع شخص فتيلي كله ❤️
Inspired By @The_E4, @B_6_Q, @Xx_xUx_xX, @B_9_BB, @Jr_HeRo, @H33OO (اجدع ناس)
Enjoy 😜
""")
        keyboard = generate_keyboard(message.chat.id)
        sent_message = bot.send_video(message.chat.id, 'https://t.me/BottishActi/13', reply_markup=keyboard)
